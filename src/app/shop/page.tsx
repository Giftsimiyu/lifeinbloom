...
import { getFeaturedProducts, getProductCategories, getAllProducts, getTotalProductCount } from "@/sanity/lib/sanity";
...
export default async function ShopPage({
  ...
  const allProducts = await getAllProducts(PRODUCTS_PER_PAGE, offset);
  ...
  return (
    <main className="bg-(--color-background-secondary)">
      {/* Hero Section */}
      <section className="relative bg-(--color-background-primary) py-20 md:py-28 overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-8 relative z-10">
          <HeroSection>
            ...
            <p className="text-base md:text-lg leading-relaxed max-w-2xl mx-auto" style={{ color: "var(--color-neutral-grey)" }}>
              Thoughtfully selected products to enhance your journey of intentional living and personal growth.
            </p>
          </HeroSection>
        </div>
      </section>
